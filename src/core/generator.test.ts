...
describe('generatePiloti', () => {
  ...
  it('keeps linked shoulder bearings inside an offset upper mass', () => {
    ...
    for (let column = 1; column <= 3; column += 1) {
      ...
      expect(shoulder.topOffset[0] - originalShoulder.topOffset[0]).toBeCloseTo(
        60,
        10,
      )
      expect(shoulder.topOffset[1] - originalShoulder.topOffset[1]).toBeCloseTo(
        -90,
        10,
      )
